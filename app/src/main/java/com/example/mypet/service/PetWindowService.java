...
public class PetWindowService extends Service {
    ...
    class RefreshTask extends TimerTask{
        @Override
        public void run() {
            Log.e("PetWindowService","PetWindowService RefreshTask run");
            boolean flag1=isHome();
            boolean flag2=MyWindowManager.isWindowShowing();
            // 当前界面是桌面，且没有悬浮窗显示，则创建悬浮窗。
            if (flag1 && !flag2) {
                Log.e("PetWindowService","Now is home and no floatwindow");
            ...
            // 当前界面是桌面，且有悬浮窗显示，则更新界面。
            else if (flag1 && flag2) {
                Log.e("PetWindowService","Now is home and have floatwindow,update it");
                handler.post(new Runnable() {
                    @Override
                    public void run() {
